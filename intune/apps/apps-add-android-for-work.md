...
- **Managed Google Play web app** - Web links with IT admin-defined icons that are deployable to Android Enterprise devices. These links appear on devices in the device's app list just like regular apps.
...
Browse and select Managed Google Play store apps directly in the Intune admin center. This view opens directly in the [Microsoft Intune admin center](https://go.microsoft.com/fwlink/?linkid=2109431) and doesn't require you to reauthenticate with a different account.
...
> [!IMPORTANT]
> This method is no longer supported and it’s recommended to add apps directly in the Microsoft Intune admin center. For more information, see [Support Tip: Intune moving to support new Google Play Android Management API - Microsoft Community Hub](https://techcommunity.microsoft.com/t5/intune-customer-success/support-tip-intune-moving-to-support-new-google-play-android/ba-p/3849875)
...
8. Click **Create**.
9. Click **Select** for the private app you want to sync.
...
5. Select **Apps** > **All apps** > **Add**.
6. In the **Select app type** pane, under the available **Store app** types, select **Managed Google Play app**.
7. Click **Select**. The **Managed Google Play** app store is displayed within Intune.
...
8. Click **Create**.
9. Click **Select** for the web app you want to sync.
10. Click **Sync** on the **App app** pane to sync with the Managed Google Play service.

    > [!NOTE]
    > Web apps may take several minutes to become available to sync. If the web app does not appear the first time you perform a sync, wait a couple minutes, click the **Select** button for the web app you want to sync, and then initiate a new sync.
